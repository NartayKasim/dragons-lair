...
export default class Container extends Component {
  ...
  getDragonTreasure() {
    ...
    axios.get('/api/treasure/dragon')
      .then(response => this.setState({ treasures: { ...this.state.treasures, dragon: response.data } }))
  ...
  getAllTreasure() {
    ...
    axios.get('/api/treasure/all')
      .then(response => this.setState({ treasures: { ...this.state.treasures, all: response.data } }))
